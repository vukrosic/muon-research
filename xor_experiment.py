...
def train_model(optimizer_name, lr, num_epochs=5000, hidden_size=4, seed=42):
    """
...
def run_experiment(num_trials=5, num_epochs=5000):
    ...
    muon_lr = 0.02  # Default Muon learning rate
...
if __name__ == "__main__":
    # Run the experiment
    results = run_experiment(num_trials=5, num_epochs=5000)
